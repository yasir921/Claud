        ...
        {steps.map((step, index) => (
          <div key={step.num} className="flex items-center">
            <button
              ...
              className="flex flex-col items-center gap-1 sm:gap-1.5 transition-all"
            >
              <div
                className={`w-9 h-9 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl flex items-center justify-center text-xs sm:text-sm font-bold transition-all duration-300 ${
            ...
            {index < steps.length - 1 && (
              <div className="relative w-6 sm:w-12 md:w-16 h-1 mx-1 sm:mx-1.5 rounded-full bg-surface-2 overflow-hidden">
                <div
